...
const STUECKE=[
  { name:'Ladenfunk', pegel:1.01, bpm:108, ton:65, skala:'dur', prog:[0,5,3,4,0,5,3,4],
    stil:'funk',
    motivA:[4,null,'-',2, 4,null,5,'-', 4,null,2,null, 0,'-','-',null],
    motivB:[7,'-',6,'-', 4,null,2,4, 5,'-','-',4, 2,null,null,null] },
  { name:'Schneeflocken', pegel:0.92, bpm:82, ton:62, skala:'dur', prog:[0,4,5,3,0,4,3,4],
    stil:'winter',
    motivA:[7,'-','-',6, 4,'-','-',null, 2,'-',4,'-', 7,'-','-','-'],
    motivB:[9,'-',7,'-', 6,'-',4,'-', 5,'-','-',4, 2,'-','-','-'] },
  { name:'Mitternacht', pegel:0.87, bpm:124, ton:57, skala:'moll', prog:[0,5,2,6,0,5,2,6],
    stil:'dance',
    motivA:[7,null,7,null, 9,null,7,'-', 4,null,4,null, 2,'-',4,null],
    motivB:[9,'-',11,'-', 9,null,7,null, 7,'-',4,'-', 2,null,4,null] },
  { name:'Pixelparty', pegel:1.74, bpm:138, ton:55, skala:'dur', prog:[0,3,1,4,0,3,4,4],
    stil:'chip',
    motivA:[4,null,7,null, 9,7,4,null, 2,null,4,7, 4,null,null,null],
    motivB:[11,null,9,null, 7,null,9,11, 12,'-','-',9, 7,null,4,null] },
  { name:'Glühweinpolka', pegel:1.37, bpm:120, ton:55, skala:'dur', prog:[0,4,4,0,0,4,4,0],
    stil:'polka',
    motivA:[4,null,4,null, 5,null,4,null, 2,'-',0,null, 2,null,4,null],
    motivB:[7,'-',7,null, 9,null,7,null, 5,null,4,null, 2,'-','-',null] },
  { name:'Lagerhallen-Groove', pegel:1.38, bpm:88, ton:62, skala:'moll', prog:[0,5,3,4,0,5,3,6],
    stil:'hiphop',
    motivA:[7,'-',null,null, null,null,4,'-', 5,null,4,null, 2,'-','-',null],
    motivB:[9,'-',7,null, null,4,'-',null, 5,'-',4,'-', 2,null,0,null] },
  { name:'Kassensturz', pegel:0.92, bpm:148, ton:52, skala:'moll', prog:[0,5,2,6,0,5,2,6],
    stil:'rock',
    motivA:[7,'-',7,'-', 9,'-',7,'-', 4,'-','-','-', 2,'-',4,'-'],
    motivB:[11,'-',9,'-', 7,'-',9,'-', 11,'-','-','-', 12,'-','-','-'] },
  { name:'Sternenstaub', pegel:0.77, bpm:72, ton:60, skala:'dur', prog:[0,5,3,4,0,5,3,4],
    stil:'ambient',
    motivA:[9,'-','-','-', '-','-',7,'-', '-','-',4,'-', '-','-','-','-'],
    motivB:[11,'-','-','-', 9,'-','-','-', 7,'-','-','-', 4,'-','-','-'] },
  { name:'Countdown', pegel:0.81, bpm:134, ton:53, skala:'moll', prog:[0,5,2,6,0,5,2,6],
    stil:'trance',
    motivA:[7,null,4,null, 7,null,9,null, 7,null,4,null, 2,null,4,null],
    motivB:[9,'-',11,'-', 12,'-',11,'-', 9,'-',7,'-', 4,'-',7,'-'] },
  { name:'Lo-Fi Ladenschluss', pegel:1.64, bpm:76, ton:60, skala:'moll', prog:[0,5,3,6,0,5,3,4],
    stil:'lofi',
