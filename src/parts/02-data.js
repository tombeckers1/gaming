...
const UPGRADES=[
  ...
  {id:'rampe2',kat:'flaeche',lvl:28,req:'lager_west',name:'Zweite Andockstation',desc:'Tor 2 der Westhalle geht in Betrieb. Ab jetzt können zwei Lieferungen gleichzeitig anrollen: während du an der Basisrampe auslädst, stapelt der Fahrer hier seine Kartons selbst in der Halle ab.',cost:()=>14000,done:()=>S.up.rampe2},
  ...
  {id:'rampe4',kat:'flaeche',lvl:30,req:'rampe3',name:'Vierte Andockstation',desc:'Das letzte Tor der Westhalle. Vier Lieferungen gleichzeitig, mehr gibt das Grundstück nicht her.',cost:()=>25000,done:()=>S.up.rampe4},
