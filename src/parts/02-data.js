...
const P={
  ...
  /* Boeller seit dem 25.09. (Toms PDF): nur noch drei, jeder mit
     eigenem Auftritt. Der Furzboeller behaelt den Schluessel 'boeller',
     damit alte Spielstaende und Pakete ihn weiter finden. */
  boeller:{name:'Pupsalarm · 10 Furzböller',short:'Furzböller',cat:2,lvl:4,shape:'tubepack',dims:[0.15,0.057,0.057],grid:[8,2,2],box:16,cost:1.90,market:4.49,weight:9,hype:8,risk:4,
    desc:'Kleiner Knall, dann ein langer, flatternder Pups und eine grünbraune Wolke.',
    art:{title:'FURZBÖLLER',sub:'10 Stück · mit Geräusch',bg1:'#8fb03a',bg2:'#4d3a14',ac:'#fff3a0',ac2:'#5a3a10'}},
  monsterboeller:{name:'Monster Böller · 4 Stück',short:'Monster Böller',cat:2,lvl:9,shape:'tubepack',dims:[0.17,0.075,0.075],grid:[7,2,2],box:12,cost:5.40,market:12.99,weight:7,hype:18,risk:7,
    desc:'Der lauteste Böller im Laden: Feuerball am Boden, Druckring, zwei Echos von den Häusern.',
    art:{title:'MONSTER',sub:'4 Böller · extrem laut',bg1:'#1a1d22',bg2:'#000000',ac:'#9cff3a',ac2:'#ff3b2e'}},
  atomboeller:{name:'Atombomben-Böller »Großer Pilz«',short:'Atom-Böller',cat:2,lvl:17,shape:'atombombe',dims:[0.15,0.3,0.15],grid:[5,1,1],box:5,cost:15.50,market:36.99,weight:5,hype:52,risk:10,
    desc:'Steigt auf und geht als riesiger Atompilz auf: Weißblitz, Feuerball, Kappe, Stiel und Druckwelle.',
    art:{title:'ATOMBOMBE',sub:'1 Stück · Großer Pilz',bg1:'#f2d21b',bg2:'#1b1b1b',ac:'#1b1b1b',ac2:'#ff7a1c',light:true}},
  ...
  titanraketen:{name:'Titan · 3 XXL-Raketen Silberbruch',short:'Titan',cat:2,lvl:20,shape:'rocketset',dims:[0.62,0.085,0.18],grid:[3,1,1],box:3,cost:19.00,market:44.99,weight:5,hype:44,risk:9,
    art:{title:'TITAN',sub:'3 XXL-Raketen · Silberbruch',bg1:'#26292f',bg2:'#000000',ac:'#d1e5ff',ac2:'#ffd23f'}},
  ...
  jumboleiter:{name:'Jumbo-Rakete »Polarstern«',short:'Jumbo Stern',cat:2,lvl:22,shape:'rocketset',stueck:1,dims:[0.84,0.12,0.17],grid:[2,1,1],box:2,cost:22.00,market:52.99,weight:3,hype:58,risk:10,
    art:{title:'JUMBO',sub:'Polarstern · Sternbruch',bg1:'#12204a',bg2:'#04081a',ac:'#8fd0ff',ac2:'#ffd23f'}},
  ...
  stabfeuerzeug:{name:'Stabfeuerzeug & Anzündlunte',short:'Stabfeuerzeug',cat:0,lvl:3,shape:'boxA',dims:[0.09,0.3,0.035],grid:[14,2,1],box:24,cost:1.30,market:3.49,weight:8,hype:0,risk:3,
    art:{title:'STABFEUERZEUG',sub:'mit Anzündlunte',bg1:'#2a2f3d',bg2:'#0b0d14',ac:'#ff7a3d',ac2:'#ffd23f'}},
  ballons:{name:'Luftballon-Set »Frohes Neues« mit Zahlen 2027',short:'Luftballons',cat:0,lvl:6,shape:'boxA',dims:[0.22,0.28,0.06],grid:[8,2,1],box:16,cost:1.90,market:4.99,weight:7,hype:0,risk:1,
    art:{title:'FROHES NEUES',sub:'30 Ballons + Zahlen 2027',bg1:'#1d1d6b',bg2:'#07072a',ac:'#ffd23f',ac2:'#ff4fa3'}},
  partyhuete:{name:'Partyhüte & Tröten 10er',short:'Partyhüte',cat:0,lvl:6,shape:'boxA',dims:[0.26,0.3,0.12],grid:[6,2,1],box:10,cost:2.30,market:5.99,weight:7,hype:0,risk:1,
    art:{title:'PARTYHÜTE',sub:'10 Hüte + 10 Tröten',bg1:'#c01c6a',bg2:'#4a0626',ac:'#ffd23f',ac2:'#5ce1ff'}},
  luftruessel:{name:'Luftrüssel 12er',short:'Luftrüssel',cat:0,lvl:6,shape:'boxA',dims:[0.16,0.24,0.045],grid:[10,2,1],box:24,cost:1.10,market:2.99,weight:6,hype:0,risk:1,
    art:{title:'LUFTRÜSSEL',sub:'12 Stück, bunt',bg1:'#0f7a6b',bg2:'#03302a',ac:'#fff3a0',ac2:'#ff7a3d'}},
  girlanden:{name:'Girlanden & Wimpelketten Gold-Silber',short:'Girlanden',cat:0,lvl:6,shape:'boxA',dims:[0.2,0.26,0.05],grid:[10,2,1],box:20,cost:1.50,market:3.99,weight:6,hype:0,risk:1,
    art:{title:'GIRLANDEN',sub:'Gold & Silber, 10 m',bg1:'#3a2c08',bg2:'#120d02',ac:'#ffd23f',ac2:'#d1e5ff'}},
  folienvorhang:{name:'Folienvorhang Gold & Silber 2 m',short:'Folienvorhang',cat:0,lvl:6,shape:'boxA',dims:[0.2,0.3,0.04],grid:[10,2,1],box:20,cost:1.70,market:4.49,weight:5,hype:0,risk:1,
    art:{title:'GLITZERVORHANG',sub:'Gold & Silber · 2 m',bg1:'#8a8f99',bg2:'#2a2e36',ac:'#ffd23f',ac2:'#f2f5ff'}},
  tischdeko:{name:'Tischdeko-Set Silvester',short:'Tischdeko',cat:0,lvl:6,shape:'boxA',dims:[0.3,0.22,0.08],grid:[6,2,1],box:12,cost:2.70,market:6.99,weight:5,hype:0,risk:1,
    art:{title:'TISCHDEKO',sub:'Streukonfetti · Servietten · Kerzen',bg1:'#0c3d2a',bg2:'#021a10',ac:'#ffd23f',ac2:'#ff4a4a'}},
  geschirr:{name:'Partygeschirr 60-teilig: Becher, Teller, Besteck',short:'Partygeschirr',cat:0,lvl:6,shape:'boxA',dims:[0.28,0.2,0.2],grid:[6,2,2],box:10,cost:2.10,market:5.49,weight:6,hype:0,risk:1,
    art:{title:'PARTYGESCHIRR',sub:'60 Teile für 20 Gäste',bg1:'#f2ecd8',bg2:'#d8c49a',ac:'#1b5fa8',ac2:'#1b5fa8',light:true}},
  partyspiel:{name:'Silvester-Partyspiel »Countdown«',short:'Partyspiel',cat:0,lvl:9,shape:'boxA',dims:[0.3,0.3,0.07],grid:[6,2,2],box:8,cost:5.20,market:12.99,weight:5,hype:0,risk:2,
    art:{title:'COUNTDOWN',sub:'Das Silvester-Partyspiel',bg1:'#6a1a8a',bg2:'#1a0626',ac:'#ffd23f',ac2:'#5ce1ff'}},
  secco:{name:'Secco alkoholfrei',short:'Secco',cat:0,lvl:9,cold:true,shape:'bottle',dims:[0.08,0.3,0.08],grid:[12,2,1],box:12,cost:1.60,market:3.99,weight:7,hype:0,risk:3,
    art:{title:'SECCO',sub:'alkoholfrei',bg1:'#f4f0e0',bg2:'#d8cfa8',ac:'#c8a23a',ac2:'#c8a23a'}},
  partyfass:{name:'Partyfass Pils 5 l',short:'Partyfass',cat:0,lvl:9,cold:true,shape:'fass',dims:[0.24,0.34,0.24],grid:[6,1,1],box:4,cost:6.20,market:14.99,weight:6,hype:0,risk:4,
    art:{title:'PARTYFASS',sub:'Pils · 5 Liter',bg1:'#1b5a2a',bg2:'#062a10',ac:'#ffd23f',ac2:'#e8e2c8'}},
  gluehwein:{name:'Glühwein 1 l',short:'Glühwein',cat:0,lvl:9,shape:'boxA',dims:[0.1,0.25,0.07],grid:[14,2,1],box:12,cost:1.40,market:3.49,weight:6,hype:0,risk:2,
    art:{title:'GLÜHWEIN',sub:'rot · 1 Liter',bg1:'#7a0f1e',bg2:'#2a0308',ac:'#ffd23f',ac2:'#e8b418'}},
  fonduegeraet:{name:'Fondue-Set elektrisch für 8 Personen',short:'Fondue-Gerät',cat:0,lvl:12,shape:'boxA',dims:[0.36,0.3,0.3],grid:[5,1,1],box:3,cost:16.00,market:39.99,weight:3,hype:0,risk:6,
    art:{title:'FONDUE',sub:'elektrisch · 8 Gabeln',bg1:'#1a1d22',bg2:'#000000',ac:'#ff7a1c',ac2:'#d1e5ff'}},
  raclettegeraet:{name:'Raclette-Grill für 8 Personen',short:'Raclette-Gerät',cat:0,lvl:12,shape:'boxA',dims:[0.48,0.2,0.3],grid:[4,1,2],box:3,cost:18.00,market:44.99,weight:3,hype:0,risk:6,
    art:{title:'RACLETTE',sub:'Grill für 8 Personen',bg1:'#26292f',bg2:'#0b0d14',ac:'#ffd23f',ac2:'#ff4a4a'}},
  fondueessen:{name:'Fondue-Platte für 4: Fleisch, Soßen, Beilagen',short:'Fondue-Platte',cat:0,lvl:12,cold:true,kuehlpflicht:true,shape:'boxA',dims:[0.3,0.09,0.22],grid:[3,2,3],box:6,cost:10.00,market:24.99,weight:4,hype:0,risk:5,
    art:{title:'FONDUE-PLATTE',sub:'für 4 · gekühlt',bg1:'#8a1a1a',bg2:'#3a0606',ac:'#fff3c4',ac2:'#ffd23f'}},
  racletteessen:{name:'Raclette-Paket für 4: Käse, Kartoffeln, Beilagen',short:'Raclette-Paket',cat:0,lvl:12,cold:true,kuehlpflicht:true,shape:'boxA',dims:[0.3,0.1,0.22],grid:[3,2,3],box:6,cost:8.00,market:19.99,weight:4,hype:0,risk:5,
    art:{title:'RACLETTE-PAKET',sub:'für 4 · gekühlt',bg1:'#e8b418',bg2:'#8a5a08',ac:'#1b1b1b',ac2:'#c8322a',light:true}},
