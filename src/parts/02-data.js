...
const UPGRADES=[
  ...
  {id:'shop_halb',kat:'flaeche',lvl:4,name:'Die Wand muss weg',desc:'Die zugemauerte Hälfte deines eigenen Ladenlokals: rund 70 Quadratmeter mehr, das zweite Schaufenster und vier weitere Regalplätze. Die Trennwand fällt beim Kauf ganz weg — ein Raum, kein Pfeiler, kein Sturz. Dahinter liegt auch die Tür zum Testfeld.',cost:()=>1400,done:()=>S.up.shop_halb},
  {id:'testfeld',kat:'flaeche',lvl:9,req:'shop_halb',name:'Freies Feld zum Zünden',desc:'Der abgesperrte Hof hinter dem Laden wird dein Testfeld: Zündtisch, Abschussröhren und Mörserbatterie. Erst damit kannst du selbst zünden — und was du gezündet hast, spricht sich herum.',cost:()=>3200,done:()=>S.up.testfeld},
  {id:'shop_gross',kat:'flaeche',lvl:12,req:'shop_halb',name:'Das Lokal nebenan',desc:'Kauft das leerstehende Ladenlokal rechts nebenan. Die Ostwand wird durchbrochen, die Schaufenster werden entmauert: rund 78 Quadratmeter mehr Fläche und acht zusätzliche Regalplätze.',cost:()=>7500,done:()=>S.up.shop_gross},
  {id:'lager_nord',kat:'flaeche',lvl:6,name:'Platz hinter der Wand',desc:'Was hinter der Trennwand im Lager liegt: 47 Quadratmeter mehr, sechs zusätzliche Stellplätze für Regale. Die Wand fällt beim Kauf ganz weg — kein Sturz, kein Pfeiler, ein durchgehender Raum bis zur Nordwand.',cost:()=>1900,done:()=>S.up.lager_nord},
  {id:'lager_gross',kat:'flaeche',lvl:15,req:'lager_nord',name:'Tor auf zur großen Halle',desc:'Hinter dem Rolltor wird die Wand auf neun Metern durchbrochen: der erste Abschnitt der großen Halle dahinter, 118 Quadratmeter mit fünf Metern lichter Höhe. Hier steht die Packstation, und ab hier lohnt sich der Onlineshop. Hochregale passen erst in diese Höhe.',cost:()=>6200,done:()=>S.up.lager_gross},
  {id:'shop_ost',kat:'flaeche',lvl:20,req:'shop_gross',name:'Noch ein Lokal dazu',desc:'Das nächste leerstehende Lokal an der Ostseite: noch einmal 212 Quadratmeter, Gondelgassen, Eckregal und eine lange Wandreihe.',cost:()=>16000,done:()=>S.up.shop_ost},
  {id:'shop_sued',kat:'flaeche',lvl:26,req:'shop_ost',name:'Die Halle hinterm Laden',desc:'Die große Halle hinter dem Laden, zwei breite Durchgänge: 478 Quadratmeter Verkaufsfläche mit zwei Gondelgassen. Damit ist der Laden fünfeinhalbmal so groß wie am Anfang.',cost:()=>34000,done:()=>S.up.shop_sued},
  {id:'lager_sued',kat:'flaeche',lvl:20,req:'lager_gross',name:'Die Halle wächst weiter',desc:'Der zweite Abschnitt, noch einmal 83 Quadratmeter. Die Wand zum ersten fällt ganz weg — kein Pfeiler, kein Sturz, eine durchgehende Halle.',cost:()=>11000,done:()=>S.up.lager_sued},
  {id:'lager_sued2',kat:'flaeche',lvl:24,req:'lager_sued',name:'Bis ganz nach hinten',desc:'Der letzte Abschnitt bis zur Stirnwand. Damit steht die ganze Halle: 283 Quadratmeter am Stück, zwölf Stellplätze für Hoch- und Schwerlastregale.',cost:()=>15000,done:()=>S.up.lager_sued2},
  {id:'lager_west',kat:'flaeche',lvl:28,req:'lager_sued2',name:'Eigener Großhandel',desc:'Die große Halle an den drei Rampen: 505 Quadratmeter, zwölf Stellplätze für Hochregale und ein Hof, auf dem mehrere Auflieger stehen können. Dazu wird der Lagergang hinter dem Laden geöffnet — der kurze Weg vom Rückgebäude direkt ins Lager, ohne Umweg über den Verkaufsraum.',cost:()=>38000,done:()=>S.up.lager_west},
  ...
  {id:'rampe2',kat:'flaeche',lvl:28,req:'lager_west',name:'Zwei LKW gleichzeitig',desc:'Tor 2 der Westhalle geht in Betrieb. Ab jetzt können zwei Lieferungen gleichzeitig anrollen: während du an der Basisrampe auslädst, stapelt der Fahrer hier seine Kartons selbst in der Halle ab.',cost:()=>14000,done:()=>S.up.rampe2},
  {id:'rampe3',kat:'flaeche',lvl:29,req:'rampe2',name:'Drei Tore in Betrieb',desc:'Tor 3 kommt dazu. Drei Lieferungen nebeneinander — ab hier staut sich der Einkauf auch an starken Tagen nicht mehr.',cost:()=>19000,done:()=>S.up.rampe3},
  {id:'rampe4',kat:'flaeche',lvl:30,req:'rampe3',name:'Alle Tore in Betrieb',desc:'Das dritte Tor der Westhalle. Vier Lieferungen gleichzeitig.',cost:()=>25000,done:()=>S.up.rampe4},
  {id:'rampe5',kat:'flaeche',lvl:30,req:'rampe4',name:'Die Rampe ist nie voll',desc:'Das vierte Tor der Westhalle. Zusammen mit der Basisrampe rollen dann fünf Lieferungen gleichzeitig an — mehr gibt das Grundstück nicht her.',cost:()=>31000,done:()=>S.up.rampe5},
