...
const UPGRADES=[
  ...
  {id:'shop_gross',kat:'flaeche',lvl:12,req:'shop_halb',name:'Das Lokal nebenan',desc:'Kauft das leerstehende Ladenlokal nebenan. Die Seitenwand wird durchbrochen, die Schaufenster werden entmauert: rund 78 Quadratmeter mehr Fläche und acht zusätzliche Regalplätze.',cost:()=>7500,done:()=>S.up.shop_gross},
  {id:'lager_nord',kat:'flaeche',lvl:6,name:'Platz hinter der Wand',desc:'Was hinter der Trennwand im Lager liegt: 47 Quadratmeter mehr, sechs zusätzliche Stellplätze für Regale. Die Wand fällt beim Kauf ganz weg — kein Sturz, kein Pfeiler, ein durchgehender Raum bis zur Stirnwand.',cost:()=>1900,done:()=>S.up.lager_nord},
  ...
  {id:'shop_ost',kat:'flaeche',lvl:20,req:'shop_gross',name:'Noch ein Lokal dazu',desc:'Das nächste leerstehende Lokal in der Reihe: noch einmal 212 Quadratmeter, Gondelgassen, Eckregal und eine lange Wandreihe.',cost:()=>16000,done:()=>S.up.shop_ost},
